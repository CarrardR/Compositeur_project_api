  ...
  afficherCompositeurs() {
    http.chercherTousCompo((data) => {
      for (const compositeur in data.composers) {
        let s = "<a href='javascript:indexCtrl.loadCompoSpecifique(" + data.composers[compositeur].id +");'><div class='comp'><img src='" + data.composers[compositeur].portrait + "'><div class='nomComp'>" + data.composers[compositeur].complete_name + "</div></div></a>";
